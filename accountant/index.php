...
<head>
  ...
  <title>Accountant | WBDSMS For Nech Sar Hospital</title>
...
<div class="wrapper">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="../img/user.PNG" class="user-image" alt="User Image"></span></a>
          <ul class="dropdown-menu">
            <li class="user-header bg-info">
              ...
              <p><span id="user"><?php echo user(); ?></span> - Accountant</p>
            </li>
            <li class="user-body">
              <div class="row">
                <div class="pull-left">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="parch-data.php" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
                Parchasing Data
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="card" style="border-radius : 0px;"><div class="card-body"><span style="font-size : 19px; font-weight : 700;"><i class="fa fa-check" style="color : red;"></i> Welcome To <i style="color : orange">Arba Minch Nech Sar Primary Hospital</i> Drug Store Management System</span></div></div>

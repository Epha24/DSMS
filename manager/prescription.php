...
<head>
  ...
  <title>Manager | WBDISMS For Arba Minch General Hospital</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index.php" class="brand-link" title="Web Based Drag Store Information Management System">
      &nbsp;<span class="brand-text font-weight-light"> WBDSIMS - Arba Minch</span>
    </a>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-light">
              <div class="card-header">
                <h3 class="card-title">Give Comment</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="comment.php" method="POST">
                <div class="card-body">
                 ...
                 <div class="form-row">
                  <div class="form-group col-sm-12">
                    <input type="text" class="form-control" name="username" value="<?php echo $_SESSION['user_name']; ?>" readonly>
                  </div>
                  <div class="form-group col-sm-12">
                ...
                <div class="card-footer">
                  <button type="submit" name="send" class="btn btn-primary mn">Submit</button>
                </div>
              </form>
            </div>
          </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="index.php">Arba Minch WBDSIMS</a>.</strong>
    All rights reserved.

  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php if(!isset($_GET['employee']) && !isset($_GET['admin']) && !isset($_GET['owner'])){?>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info mn">
              <div class="inner">
                <?php $qry = "SELECT *FROM users WHERE role = 'manager'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success mn">
              <div class="inner">
                <?php $qry_ass = "SELECT *FROM users WHERE role = 'admin'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info mn">
              <div class="inner">
                <?php $qry_ass = "SELECT *FROM users WHERE role = 'pharmacist'";
                      $ext_ass = mysqli_query($conn,$qry_ass);
                      $num_ass = mysqli_num_rows($ext_ass);?>
                <h3><?php echo $num_ass; ?></h3>
                <p>Pharmacist</p>
          ...
          <!-- <div class="col-lg-3 col-6">
            ...
            <!--<div class="small-box bg-success mn">
              <div class="inner">
                 /*$qry_ass = "SELECT *FROM users WHERE role = 'accountant'";
                      $ext_ass = mysqli_query($conn,$qry_ass);
                      $num_ass = mysqli_num_rows($ext_ass);?>
                <h3><?php echo $num_ass; ?></h3>
                <p>Accountant</p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info mn">
              <div class="inner">
                <?php $qry_ass = "SELECT *FROM users WHERE role = 'patient'";
                      $ext_ass = mysqli_query($conn,$qry_ass);
                      $num_ass = mysqli_num_rows($ext_ass);?>
                <h3><?php echo $num_ass; ?></h3>
                <p>Patient</p>

...
if(isset($_POST['register'])){
  ...
  if(empty($_POST['sex']) || empty($_POST['dep'])){
      $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='border-radius:0px;'>
        ...
        if(isset($_POST['update_detail'])){
             ...
             $upqry = "UPDATE users SET fname = '$fname', mname = '$mname', lname = '$lname', age = '$age', sex = '$sex', phone = '$phone', address = '$address', role = '$role' WHERE username = '$username'";
...
<head>
  ...
  <title>Admin | WBDSMS For Nech Sar Hospital</title>
                 ...
                 <div class="form-row">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <select name="dep" class="form-control">
                      ...
                      <?php if($row['role'] == 'accountant') {
                        echo '<option selected="selected" value="accountant">Accountant</option>';
                      }else {
                        ...
                        echo '<option selected="selected" value="patient">Patient</option>';
                      } else {

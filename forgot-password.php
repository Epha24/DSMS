...
<head>
  ...
  <title>Arba Minch Nech Sar Primary Hospital DSMS</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php" title="Arba Minch Nech Sar Primary Hospital Drug Store Management System"><b> NSPH </b> | DSMS</a>
  </div>
  <!-- /.login-logo -->
  <?=$msg;?>
  <!-- /.login-logo -->
    ...
    <div class="card-body login-card-body">
      ...
      <form action="forgot-password.php" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" placeholder="Username" style="border-radius: 0px;">
